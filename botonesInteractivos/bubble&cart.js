...
/*--------2. Declare Functionciones ---------*/
        ...
        function getDelivery() {
                ...
                bottleNeck = [ENTREGA_GRUPO, ENTREGA_RUEDOS, ENTREGA_MANUBRIOS]
                bottleNeck = bottleNeck.max()

                delivery = Delay + bottleNeck

                shipDay = day + delivery
                ...
                shipDay = shipDay - (30*y)

                var shipDate = (shipDay + " " + Months[month] + " " + year)
...
/*--------3. Default Values (Bubble)---------*/
    // Setting Default Price
        ...
        let PRECIO_COLOR = Precio_Bronze
            ...
            LIST_OF_SIZEBIKE.forEach((e) => {
                e.addEventListener('change', (event) => {
                        ...
                        if (CuadroRuta == "XS") {
                            ...
                            PRECIO_FRAMESET = Precio-FS-S;
                            PESO_FRAMESET = Peso-FS-S;
                        } 
