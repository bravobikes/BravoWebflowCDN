...
function AddToCart() {
    ...
    items.push($('.add-to-cart-button-cuadro'));
    items.push($('.add-to-cart-grupo'));
    items.push($('.add-to-cart-llantas'));
    items.push($('.add-to-cart-button-manubrio'));
    items.push($('.add-to-cart-button-7'));
