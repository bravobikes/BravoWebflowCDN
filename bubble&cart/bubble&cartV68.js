...
const precioUpgradeRuedos = document.querySelector('#precioUpgradeRuedos');
const precioUpgradeManubrio = document.querySelector('#precioUpgradeManubrio');
const precioUpgradeGrupo = document.querySelector('#precioUpgradeGrupo');
...
precioUpgradeGrupo = 12000; // Additiona price text in option selector
//manubrio
let Precio_M_Al = 863;
let Precio_M_Carb = 860 + 5000;
precioUpgradeManubrio = 5000; // Additiona price text in option selector
    
//ruedos
let Precio_R_Al = 6013;
let Precio_R_Carb = 6013 * 2.5;
precioUpgradeRuedos = Precio_R_Carb - 6013; // Additiona price text in option selector
