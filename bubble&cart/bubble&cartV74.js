...
newPrecioG.innerText = formatMoney(Precio_G_Ult - 19833);
    
//manubrio
let Precio_M_Al = 863;
let Precio_M_Carb = 860 + 5000;
newPrecioM.innerText = formatMoney(Precio_M_Carb - 860);
    
//ruedos
let Precio_R_Al = 6013;
let Precio_R_Carb = 6013 * 2.5;
newPrecioR.innerText = formatMoney(Precio_R_Carb - 6013);
