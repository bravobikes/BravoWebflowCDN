...
newPrecioG = formatMoney((Precio_G_Ult - 19833)/conv);
newPrecioG.innerText = "+ " + newPrecioG;
    
//manubrio
let Precio_M_Al = 863;
let Precio_M_Carb = 860 + 5000;
newPrecioM = formatMoney((Precio_M_Carb - 860)/conv);
newPrecioM.innerText = "+ " + newPrecioM;

//ruedos
let Precio_R_Al = 6013;
let Precio_R_Carb = 6013 * 2.5;
newPrecioR = formatMoney((Precio_R_Carb - 6013)/conv);
newPrecioR.innerText = "+ " + newPrecioR;
