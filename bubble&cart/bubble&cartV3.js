...
var Precio = document.querySelector('#innerPrecio');
var Peso = document.querySelector('#innerPeso');

var PrecioM= document.querySelector('#innerPrecioM');
var PesoM = document.querySelector('#innerPesoM');

var Fecha = document.getElementById("fechaEntrega");
var FechaM = document.getElementById("fechaEntregaMobile");
...
/* TIPO DE CAMBIO */{
    ...
    /* Pesos */
    let CuadroRuta, CuadroType, groupsetFinal, rinesFinal, manubrioFinal;
    // en gramos
