...
let precioUpgradeRuedos = document.querySelector('#precioUpgradeRuedos');
let precioUpgradeManubrio = document.querySelector('#precioUpgradeManubrio');
let precioUpgradeGrupo = document.querySelector('#precioUpgradeGrupo');
