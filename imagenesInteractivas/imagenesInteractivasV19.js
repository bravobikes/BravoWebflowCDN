...
function CambiarImagen(){
    ...
    completeImg1 = BICIS_URLS[("06" + CODE)]
    completeImg2 = BICIS_URLS[("01" + CODE)]
    completeImg3 = BICIS_URLS[("06" + CODE)]
    completeImg4 = BICIS_URLS[("00" + CODE)]
    completeImg5 = BICIS_URLS[("02" + CODE)]
    completeImg6 = BICIS_URLS[("03" + CODE)]
    completeImg7 = BICIS_URLS[("04" + CODE)]
    grupo1 = BICIS_URLS[("02" + CODE)]
    ruedos1 =BICIS_URLS[("06" + CODE)]
    ruedos2 = BICIS_URLS[("03" + CODE)]
    manubrioImg1 = BICIS_URLS[("06" + CODE)]
     
    imagenMobile = BICIS_URLS[("00" + CODE)]
    completeImg1Mobile = BICIS_URLS[("06" + CODE)]
    grupoMobile1 = BICIS_URLS[("02" + CODE)]
    ruedos1Mobile =BICIS_URLS[("06" + CODE)]
    ruedos2Mobile = BICIS_URLS[('03'+ CODE)]
    manubrioImgMobile1 = BICIS_URLS[("06" + CODE)];
