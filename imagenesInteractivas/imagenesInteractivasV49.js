...
const BICIS_URLS = {
    ...
    '000000000PU0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7ff01105431ad5148f369_finish-III.8.png',
    // 'Purple-classic-br':
    ...
    '000000011PU0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7ff01105431ad5148f369_finish-III.8.png',
    // 'Purple-sleeve-br':
    ...
    '000000012PU0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7ff01105431ad5148f369_finish-III.8.png',
    ...
    '000000000VI0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7fefa20655fa9cbcb3698_finish-III.3.png',
    // 'Violet-classic-br':
    ...
    '000000011VI0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7fefa20655fa9cbcb3698_finish-III.3.png',
    // 'Violet-sleeve-br':
    ...
    '000000012VI0001':'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/64b7fefa20655fa9cbcb3698_finish-III.3.png',
...
$('input[name="rines"]').click( function(){
    ...
    if (rinesFinal == 1){
        // completeImg2.src = BICIS_URLS[('200000100NA000')]
        // completeImg3.src = BICIS_URLS[('300000100NA000')]
        grupo1.src =  BICIS_URLS[('500000100NA000')]
        grupo2.src =  BICIS_URLS[('600000100NA000')]
        ...
        // completeImg2.src = BICIS_URLS[('200000100NA001')]
        // completeImg3.src = BICIS_URLS[('300000100NA001')]
        grupo1.src = BICIS_URLS[('500000100NA001')]
        grupo2.src = BICIS_URLS[('600000100NA001')]
