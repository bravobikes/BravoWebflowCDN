...
const BICIS_URLS = {
    ...
    // 'Bronze-classic-sb': 
    '000000111BL000': 'https://uploads-ssl.webflow.com/6149043a3c69c4356cdb74b7/63a640f52051425b5450f8b0_Road-SB-Sleeve-Bronze.webp',
    // 'Bronze-sleeve-sb':
...
$('input[name="rines"]').click( function(){
    ...
    if (rinesFinal == 1){
        completeImg2 = BICIS_URLS[('200000100NA000')]
        completeImg3 = BICIS_URLS[('300000100NA000')]
        grupo1 =  BICIS_URLS[('500000100NA000')]
        grupo2 =  BICIS_URLS[('600000100NA000')]
        ...
        completeImg2 = BICIS_URLS[('200000100NA001')]
        completeImg3 = BICIS_URLS[('300000100NA001')]
        grupo1 =  BICIS_URLS[('500000100NA001')]
        grupo2 =  BICIS_URLS[('600000100NA001')]
